      ...
      <div className="lg:px-36 lg:mt-32 text-center flex flex-col leading-5">
        ...
        <div className="w-2/3 text-justify [&_div]:my-8 self-center">
          <div className="[&_h3]:font-medium [&_h3]:text-2xl [&_h3]:my-3 [&_p]:text-xl">
            ...
            <p>
              Използвайте безплатния инструмент за търсене на нашия уебсайт, за да намерите и да изпратите съобщение на гледачите на домашни любимци. Препоръчваме ви да си създадете профил, като кликнете върху "Регистрация" или "Намерете гледач"  на нашата начална страница.
            </p>
            <p>
        ...
        <div className="w-2/3 text-justify [&_div]:my-8 self-center">
          ...
          <div className="[&_h3]:font-medium [&_h3]:text-2xl [&_h3]:my-3 [&_p]:text-xl">
            ...
            <p>Да. Винаги можете да поемете инициативата и да потърсите обявите на хора търсещи услуги от бутона "Намерете работа".</p>
          </div>
          <div className="[&_h3]:font-medium [&_h3]:text-2xl [&_h3]:my-3 [&_p]:text-xl">
            ...
            <p>Когато създавате своя акаунт като Гледач на домашни любимци, дневната ви тарифа е зададена по подразбиране. След това можете да я коригирате чрез достъп до "Настройки". Не забравяйте да проверявате дневната си тарифа и да я променяте, ако желаете. </p>
          </div>
        </div>
      </div>
